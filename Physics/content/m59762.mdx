...
bullet Astronomy Picture of the Day: [temporarily unnamed link](). Two space scientists scour the internet and select one beautiful astronomy image to feature each day. Their archives range widely, from images of planets and nebulae to rockets and space instruments; they also have many photos of the night sky. The search function (see the menu on the bottom of the page) works quite well for finding something specific among the many years’ worth of daily images.
bullet Hubble Space Telescope Images: [temporarily unnamed link]()  or James Webb Space Telescope Images:  [temporarily unnamed link](). Here you can browse some of the remarkable images from these two space telescopes, select a particular subject in the menu boxes, or search for the name of an object that intrigues you in this book.
bullet National Aeronautics and Space Administration’s (NASA’s) Planetary Photojournal: [temporarily unnamed link](). This site features thousands of images from NASA planetary exploration, with captions of varied length. You can select images by world, feature name, date, or catalog number, and download images in a number of popular formats. Use the Photojournal Search option on the menu at the top of the homepage to access ways to search their archives.

See [temporarily unnamed link]() for more sources of astronomical images.



### Videos

Powers of Ten: [temporarily unnamed link](). This classic short video is a much earlier version of Powers of Ten, narrated by Philip Morrison (9:00).

The Known Universe: [temporarily unnamed link](). This video tour from the American Museum of Natural History has realistic animation, music, and captions (6:30).

Wanderers: [temporarily unnamed link](). This video provides a tour of the solar system, with narrative by Carl Sagan, imagining other worlds with dramatically realistic paintings (3:50).
